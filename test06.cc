    ...
    while( c<100){
        ...
        for (const auto& element : elements(gridView)){
            ...
            for (int i = 0; i < 3; i++){
                ...
                else if (element.geometry().corner(i)[1] > yBorderU) upper = true;
            ...
            //double epsilon = 5e-3;
            //if(yBorderU - yCenterHeight < epsilon || yBorderD - yCenterHeight < epsilon) continue; // border close to middle of triangle (in right angle)
